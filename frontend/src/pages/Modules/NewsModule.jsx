...
import { FileText, Link as LinkIcon, Loader2, AlertCircle, Sparkles, Globe, AlignLeft } from 'lucide-react';
import api from '../../api';
  ...
  return (
    <div className="max-w-4xl mx-auto py-6">
      <div className="mb-8 animate-in fade-in slide-in-from-top-4">
        <div className="inline-flex items-center space-x-2 bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-xs font-bold mb-3">
          <Sparkles className="h-3.5 w-3.5" />
          <span>RoBERTa Misinformation Classifier & Fact-Check Cross-Reference</span>
        </div>
        <h1 className="text-3xl font-black text-dark tracking-tight mb-2">Fake News & Misinformation Verification</h1>
        <p className="text-sm text-gray-500">Scan news articles, social media posts, or headline claims for bias, factual inaccuracies, and coordinated disinformation.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="lg:col-span-2">
          <div className="glass-card p-6">
            {/* Input Toggle */}
            <div className="flex space-x-3 mb-6 p-1 bg-gray-100/80 rounded-xl">
              <button
                type="button"
                onClick={() => { setInputType('text'); setContent(''); setError(''); }}
                className={`flex-1 py-2.5 px-4 rounded-lg font-bold text-xs flex justify-center items-center space-x-2 transition-all cursor-pointer ${
                  inputType === 'text'
              ...
              {inputType === 'text' ? (
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-2 px-1">
                    TruthLens will inspect domain reputation, meta headers, and publisher verification registries.
                  </p>
                </div>
              )}
            </div>
            ...
            {/* Progress Ticker */}
            {loading && (
              <div className="mt-4 mb-6 p-4 rounded-xl bg-blue-50 border border-blue-100 animate-in fade-in">
                <div className="flex items-center space-x-3 mb-2">
                  <Loader2 className="h-5 w-5 text-blue-600 animate-spin" />
                  <p className="text-sm font-bold text-blue-900">{scanSteps[scanStep]}</p>
                </div>
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="btn-primary space-x-2 bg-blue-600 hover:bg-blue-700 shadow-blue-500/20"
              >
                {loading ? (
                  <>
        ...
        <div className="space-y-6">
          <div className="glass-card p-6">
            <h3 className="text-sm font-bold text-dark uppercase tracking-wider mb-4">NLP Evaluation Signals</h3>
            ...
            <div className="space-y-4 text-xs">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Detects emotionally provocative phrasing, hyperbole, and manipulative headlines.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Cross-verifies claims against AP, Reuters, BBC, and independent fact-checking wires.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Evaluates partisan slant, confirmation bias phrasing, and synthetic prose markers.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-5 bg-gradient-to-br from-blue-50/50 to-white border-blue-100">
            <p className="text-xs font-bold text-blue-900 mb-1">Explainable AI</p>
