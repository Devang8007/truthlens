...
export default function Settings({ user, setUser }) {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-dark tracking-tight">Organization & User Settings</h1>
        <p className="text-sm text-gray-500 mt-1">Configure your TruthLens account, API credentials, and detection heuristics.</p>
      </div>
      ...
      <div className="glass-card p-8">
        ...
        {activeTab === 'profile' && (
          <form onSubmit={handleProfileSave} className="space-y-6 max-w-2xl">
            <div className="flex items-center space-x-5 pb-6 border-b border-gray-100">
              <div className="h-20 w-20 rounded-2xl bg-primary text-white font-black text-3xl flex items-center justify-center shadow-md shadow-primary/30">
                {profileData.username ? profileData.username.charAt(0).toUpperCase() : 'U'}
              </div>
              <div>
                <h3 className="text-lg font-bold text-dark">{profileData.username || 'Researcher'}</h3>
            ...
            <div className="pt-4 flex justify-end">
              <button type="submit" disabled={loading} className="btn-primary space-x-2">
        ...
        {activeTab === 'security' && (
          <div className="max-w-2xl space-y-8">
            <div>
              <h3 className="text-lg font-bold text-dark mb-1">Password Authentication</h3>
              <p className="text-xs text-gray-500 mb-6">Ensure your account uses a secure password of at least 6 characters.</p>
        ...
        {activeTab === 'api' && (
          <div className="max-w-3xl space-y-6">
            <div>
              <h3 className="text-lg font-bold text-dark mb-1">Enterprise API Credentials</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    readOnly
                    value={apiKey}
                    className="input-field font-mono text-sm bg-gray-50"
                  />
                  <button
                    onClick={handleCopyApiKey}
                    className="btn-secondary space-x-1.5 shrink-0 px-4"
                  >
                  ...
                  <button
                    ...
                    className="btn-secondary space-x-1.5 shrink-0 px-4 text-danger hover:border-danger/30"
                  >
            ...
            <div className="pt-4 border-t border-gray-100">
              ...
              <div className="bg-slate-900 text-slate-200 p-4 rounded-xl font-mono text-xs overflow-x-auto leading-relaxed">
        ...
        {activeTab === 'thresholds' && (
          <div className="max-w-2xl space-y-6">
            <div>
              <h3 className="text-lg font-bold text-dark mb-1">Forensic Sensitivity Tuning</h3>
              <p className="text-xs text-gray-500 mb-6">Adjust algorithmic anomaly detection thresholds across neural models.</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t border-gray-100">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-dark">Strict Latent Fingerprinting</p>
                    <p className="text-xs text-gray-500">Flag minor frequency noise anomalies as potential AI generation.</p>
                  </div>
                  <input
                    type="checkbox"
                    checked={preferences.strictMode}
                    onChange={(e) => setPreferences({ ...preferences, strictMode: e.target.checked })}
                    className="h-5 w-5 rounded text-primary accent-primary cursor-pointer"
                  />
                </div>

                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-dark">Auto-Archive Analyses to Database</p>
                    <p className="text-xs text-gray-500">Automatically save every run to your tamper-proof verification history.</p>
                  </div>
                  <input
                    type="checkbox"
              ...
              <div className="pt-4 flex justify-end">
                <button onClick={handleProfileSave} disabled={loading} className="btn-primary space-x-2">
                  <Save className="h-4 w-4" />
        ...
        {activeTab === 'diagnostics' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-bold text-dark mb-1">Architecture Infrastructure Diagnostics</h3>
              <p className="text-xs text-gray-500 mb-6">Real-time telemetry of microservice health and database connections.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-bold uppercase tracking-wider text-gray-400">API Gateway</span>
                  <Server className="h-5 w-5 text-primary" />
                </div>
                <div className="text-lg font-bold text-dark">{systemHealth.gateway}</div>
                <span className="inline-block mt-2 px-2 py-0.5 rounded-full text-[10px] font-bold bg-green-50 text-secondary">
                  HTTP 200 OK
                </span>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100">
                ...
                <div className="text-lg font-bold text-dark">{systemHealth.database}</div>
                <span className="inline-block mt-2 px-2 py-0.5 rounded-full text-[10px] font-bold bg-blue-50 text-primary">
                  Replica / Primary
                </span>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-bold uppercase tracking-wider text-gray-400">AI Microservice</span>
                  <Cpu className="h-5 w-5 text-purple-600" />
                </div>
                <div className="text-lg font-bold text-dark">{systemHealth.aiService}</div>
                <span className="inline-block mt-2 px-2 py-0.5 rounded-full text-[10px] font-bold bg-purple-50 text-purple-600">
                  ResNet + ELA Active
                </span>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-primary/5 border border-primary/10">
              <h4 className="text-sm font-bold text-dark mb-1">Capstone Verification Stack</h4>
